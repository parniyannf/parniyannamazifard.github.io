...
- Developed motion-activated lighting system
- Created manual override functionality
- Tested multiple recognition models for optimal accuracy and speed

### Hardware Integration
- Integrated sensors with Raspberry Pi
- Calibrated servo motors for door mechanism
- Performed iterative debugging to enhance reliability
- Improved circuit reliability through testing

## Technical Stack
- **Platform:** Raspberry Pi 4
- **Language:** Python
- **Computer Vision:** OpenCV
- **Hardware:** Servo motors, PIR sensors, camera module
- **Team Size:** 7 members
